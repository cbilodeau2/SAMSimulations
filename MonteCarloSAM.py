...
def MonteCarloSAM(graph, nsteps, A, B,C):
    ...
    for i in range(0,nsteps):  
        ...
        if np.mod(i,100)==0:
            ...
            print('Monte Carlo Step', i,end-start,np.shape(sim_EL_0)[0])
        
        # Select random edge:
        edge_sel = random.randint(0,np.shape(full_EL)[0]-1)
        
        # Set initial energy:
        ener_0 = EnerState(sim_graph_0,A,B,C)
        ...
        ener_1 = EnerState(sim_graph_1,A,B,C)
#        test_1 = TestState(sim_graph_1,A,B,C)
#        if not test_1 == ener_1:
#            print test_1, ener_1
#            break
...
#        print '---------------'
#        print np.shape(sim_graph_0.maximal_cliques(min=3,max=3))[0],ener_1,ener_0,prob
#        print sim_graph_0, EnerState(sim_graph_0,A,B,C)
#        print sim_graph_1,EnerState(sim_graph_1,A,B,C)
#        print '---------------'
    ...
    return clique_mon,n_edges_mon,prob_mon #sim_graph_0,sim_graph_1 #clique_mon,n_edges_mon,prob_mon